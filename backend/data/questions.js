...
const GUESS_THE_LIAR = [
  ...
  "What's something you've done to avoid a conversation?",
  "What's the most over-the-top reaction you've had to something small?",
  "What's the longest you've let a passive-aggressive situation go on without confronting it?",
  "What's the most ridiculous thing you've cried about?",
  "What's a trend you secretly followed but would deny?",
  "What's the most embarrassing thing in your search history?",
  "What's a show you rewatched so many times it became a personality trait?",
  "What's something you own that you've never actually used?",
  "What's the most dramatic thing you've done when you were hungry?",
  "What's the worst thing you've done to avoid doing laundry?",
  "What's a word or phrase you overuse without realising it?",
  "What's the pettiest reason you've unfollowed someone?",
  "What's the most embarrassing thing you've bought online at 2am?",
  "What's a ridiculous excuse you've used to cancel plans?",
  "What's the most dramatic thing you've said when mildly inconvenienced?",
  "What's something totally childish you still believe brings bad luck?",
  "What's the fastest you've ever eaten a meal you weren't supposed to eat alone?",
  "What's the most you've ever spent on something that broke within a week?",
  "What's a compliment you gave that was actually a subtle insult?",
  "What's a social media post you deeply regret?",
  "What's your most embarrassing sports/game moment?",
  "What's the worst fashion choice you've made and defended?",
];
...
const MOST_LIKELY_TO = [
  ...
  "Who is most likely to get into a fistfight over board games?",
  "Who is most likely to slide into a celebrity's DMs?",
  "Who is most likely to move to a different country on a whim?",
  "Who is most likely to become a morning person overnight?",
  "Who is most likely to claim they invented something?",
  "Who is most likely to accidentally become a meme?",
  "Who is most likely to forget where they parked for 45 minutes?",
  "Who is most likely to get a restraining order from a coffee shop?",
  "Who is most likely to narrate their own life out loud?",
  "Who is most likely to treat their pet better than their friends?",
  "Who is most likely to find a 20-year plan for global domination in their drawer?",
  "Who is most likely to give unsolicited life advice at a party?",
  "Who is most likely to cackle at something inappropriate at a funeral?",
  "Who is most likely to overshare in a job interview?",
  "Who is most likely to refer to themselves in the third person?",
  "Who is most likely to argue with a robot?",
  "Who is most likely to get banned from an all-you-can-eat buffet?",
  "Who is most likely to befriend a complete rival just for gossip?",
  "Who is most likely to fall asleep during their own story?",
  "Who is most likely to accidentally book a flight to the wrong city?",
  "Who is most likely to bring a PowerPoint to a casual hangout?",
  "Who is most likely to claim their crush was 'into them' despite zero evidence?",
];
...
const NEVER_HAVE_I_EVER = [
  ...
  "Never have I ever pretended to understand a movie I definitely didn't get",
  "Never have I ever dramatically quit something and come back a week later",
  "Never have I ever looked up a word someone used so I could pretend I already knew it",
  "Never have I ever said 'I'm five minutes away' when I hadn't left yet",
  "Never have I ever put something back on the shelf after the cashier already scanned it",
  "Never have I ever had a full argument with someone in my head and won",
  "Never have I ever rewatched something I'd already seen rather than start something new",
  "Never have I ever made up a fake phone call to escape a conversation",
  "Never have I ever cried in a work meeting",
  "Never have I ever looked busy when a colleague walked past",
  "Never have I ever snooped through someone else's medicine cabinet",
  "Never have I ever pretended to be more confident than I felt on a first date",
  "Never have I ever binge-watched an entire series in 24 hours",
  "Never have I ever used 'it's giving...' unironically",
  "Never have I ever bought something just to return it",
  "Never have I ever fell asleep in a place that wasn't a bed (on a flight, at work, etc.)",
  "Never have I ever started a diet on a Monday and abandoned it by Wednesday",
  "Never have I ever made a list and immediately felt too tired to do anything on it",
  "Never have I ever convinced someone a movie was good just so I had someone to talk about it with",
  "Never have I ever pretended an email sent to spam was actually spam",
  "Never have I ever asked a question in a meeting I definitely should have known the answer to",
  "Never have I ever been personally victimised by a parking ticket",
  "Never have I ever referred to a celebrity as if they were my friend",
  "Never have I ever added a skill to my resume I barely have",
];
...
const WOULD_YOU_RATHER = [
  ...
  {
    a: "Be able to fly but only at walking speed",
    b: "Be able to run at 60mph but never fly",
  },
  {
    a: "Know when you're going to die but not how",
    b: "Know how you'll die but not when",
  },
  {
    a: "Always be 10 minutes late for everything",
    b: "Always be 2 hours early for everything",
  },
  {
    a: "Only eat hot food for the rest of your life",
    b: "Only eat cold food for the rest of your life",
  },
  {
    a: "Have a photographic memory but no ability to dream",
    b: "Dream in vivid colour every night but forget everything by noon",
  },
  {
    a: "Only communicate through interpretive dance",
    b: "Only communicate through song (auto-tune included)",
  },
  {
    a: "Never be able to lie but also never have to answer a question",
    b: "Be able to lie freely but have your nose grow 1cm every time",
  },
  {
    a: "Have to narrate everything you do in third person out loud",
    b: "Have to laugh loudly after every sentence you say",
  },
  {
    a: "Live in your favourite book universe",
    b: "Live in your favourite movie universe",
  },
  {
    a: "Be the funniest person in any room you enter",
    b: "Be the smartest person in any room you enter",
  },
  {
    a: "Never need sleep but have to lie still for 8 hours anyway",
    b: "Only need 2 hours of sleep but wake up groggy every day",
  },
  {
    a: "Speak every language fluently but forget your native language",
    b: "Keep your native language but only understand 20% of any other",
  },
  {
    a: "Have the ability to pause time for 30 seconds once a day",
    b: "See 5 minutes into the future with 80% accuracy",
  },
  {
    a: "Spend a year in prison with all your friends",
    b: "Spend a year on a desert island completely alone",
  },
  {
    a: "Have unlimited money but no free time",
    b: "Have unlimited free time but only enough money to get by",
  },
  {
    a: "Have a job you hate that pays brilliantly",
    b: "Have a job you love that pays terribly",
  },
  {
    a: "Only be able to whisper for the rest of your life",
    b: "Only be able to shout for the rest of your life",
  },
  {
    a: "Forget all your memories but keep your personality",
    b: "Keep all your memories but your personality changes completely",
  },
  {
    a: "Have an alarm ring at 3am every single night of your life",
    b: "Never be able to sleep past 5am again",
  },
  {
    a: "Read minds but only while you're asleep",
    b: "Predict the future but only in terrible puns",
  },
  {
    a: "Have a pause button for conversations",
    b: "Have a rewind button for embarrassing moments",
  },
  {
  ...
  {
    a: "Always know you're being lied to but never know the truth",
    b: "Never know you're being lied to but always know people's true motives",
  },
  {
    a: "Have your inner monologue broadcast to everyone nearby",
    b: "Have your browsing history public but your thoughts private",
  },
];
...
const HOT_TAKES = [
  ...
  "Movie trailers show too much and should be 30 seconds max",
  "'Follow your passion' is terrible career advice",
  "Remote work has made people worse at communicating",
  "Phone calls are more stressful than emails for most people",
  "Most people's 'boundaries' are just preferences they're afraid to communicate",
  "True crime podcasts glorify criminals more than they help victims",
  "Social media clout is a legitimate career and people need to respect it",
  "You can tell everything about a person by how they treat service staff",
  "The best therapy is a long walk and honest conversation with a friend",
  "Buying a house is not always the smart financial move people assume it is",
  "Ghosting is sometimes the kindest way to end a situationship",
  "People who hate Mondays just hate their jobs and need to admit it",
  "Dating apps have made people worse at forming real connections",
  "Most people don't actually have a good sense of humour — they just laugh loudly",
  "It's okay to enjoy fast food without feeling guilty about it",
  "People who say they 'don't watch TV' are not superior to those who do",
  "Hustle culture is a mental health crisis disguised as ambition",
  "Your zodiac sign tells me more about you than your CV",
  "Being single in your 30s is something to celebrate, not explain",
  "Kids today are no lazier than previous generations — the world is just harder",
  "You should never lend money to family",
  "Night owls are more creative than morning people",
  "The word 'literally' no longer literally means literally and that's fine",
];
...
const TRIVIA_BLITZ = [
  ...
  },
  {
    ...
    options: ["Asia", "Americas", "Europe", "Africa"],
    correct: 3,
    cat: "geo",
  },
  {
  ...
  },
  {
    ...
    options: ["R&B", "Gospel", "Hip-hop", "Soul"],
    correct: 2,
    cat: "music",
  },
  {
  ...
  {
    q: "In which year did Netflix launch its streaming service?",
  ...
  {
    q: "What is the most popular programming language as of 2024?",
    options: ["Java", "C++", "Python", "JavaScript"],
    correct: 2,
    cat: "tech",
  },
  {
    q: "What country was the first to give women the right to vote?",
    options: ["UK", "USA", "New Zealand", "Sweden"],
    correct: 2,
    cat: "history",
  },
  {
  ...
  },
  {
    ...
    options: ["Squash", "Pickleball", "Badminton", "Table Tennis"],
    correct: 2,
    cat: "sport",
  },
  {
    q: "How many players are on each side in a volleyball game?",
    options: ["5", "6", "7", "8"],
    correct: 1,
    cat: "sport",
  },
...
const DRAW_IT_WORDS = [
  ...
  { word: "cloud", diff: 1 },
  { word: "rabbit", diff: 1 },
  { word: "mountain", diff: 1 },
  { word: "shoe", diff: 1 },
  { word: "key", diff: 1 },
  { word: "window", diff: 1 },
  { word: "bridge", diff: 1 },
  { word: "pizza slice", diff: 1 },
  { word: "traffic light", diff: 1 },
  { word: "hot dog", diff: 1 },
  { word: "sunglasses", diff: 1 },
  { word: "cactus", diff: 1 },
  // Medium additions
  { word: "quicksand", diff: 2 },
  { word: "black hole", diff: 2 },
  { word: "mime artist", diff: 2 },
  { word: "vending machine", diff: 2 },
  { word: "crowded subway", diff: 2 },
  { word: "hot air balloon", diff: 2 },
  { word: "ninja", diff: 2 },
  { word: "parachute", diff: 2 },
  { word: "compass", diff: 2 },
  { word: "escalator", diff: 2 },
  { word: "speedboat", diff: 2 },
  { word: "igloo", diff: 2 },
  { word: "detective", diff: 2 },
  { word: "juggling", diff: 2 },
  { word: "windmill", diff: 2 },
  // Hard additions
  { word: "déjà vu", diff: 3 },
  { word: "imposter syndrome", diff: 3 },
  { word: "sarcasm", diff: 3 },
  { word: "peer pressure", diff: 3 },
  { word: "binge watching", diff: 3 },
  { word: "mid-life crisis", diff: 3 },
  { word: "cancel culture", diff: 3 },
  { word: "dark mode", diff: 3 },
  { word: "passive aggressive", diff: 3 },
  { word: "plot armour", diff: 3 },
];
...
// ── BINGO ───────────────────────────────────────────────────────────────────
// 50 party-friendly items used to populate 5×5 Bingo boards.
// The FREE center tile (index 12) is handled by the engine, not drawn from here.
const BINGO_ITEMS = [
